...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Fri Sep 24 08:45:14 2010
# Project:  kiten+.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		searchablelabel.cpp moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/kiten+1.0.0/ && $(COPY_FILE) --parents mainwindow.h kanjidetails.h tests/kanjidetailsscrollareatestwindow.h readingmeaninggroupwidget.h searchablelabel.h .tmp/kiten+1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp kanjidetails.cpp tests/kanjidetailsscrollareatestwindow.cpp readingmeaninggroupwidget.cpp searchablelabel.cpp .tmp/kiten+1.0.0/ && $(COPY_FILE) --parents kanjidetails.ui readingmeaninggroupwidget.ui .tmp/kiten+1.0.0/ && (cd `dirname .tmp/kiten+1.0.0` && $(TAR) kiten+1.0.0.tar kiten+1.0.0 && $(COMPRESS) kiten+1.0.0.tar) && $(MOVE) `dirname .tmp/kiten+1.0.0`/kiten+1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/kiten+1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_kanjidetails.cpp moc_kanjidetailsscrollareatestwindow.cpp moc_readingmeaninggroupwidget.cpp moc_searchablelabel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_kanjidetails.cpp moc_kanjidetailsscrollareatestwindow.cpp moc_readingmeaninggroupwidget.cpp moc_searchablelabel.cpp
