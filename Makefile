...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Sep 13 03:39:00 2010
# Project:  kiten+.pro
# Template: app
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		kanjidetails.cpp \
		tests/kanjidetailsscrollareatestwindow.cpp moc_mainwindow.cpp \
...
$(TARGET): ui_kanjidetails.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/kiten+1.0.0/ && $(COPY_FILE) --parents mainwindow.h kanjidetails.h tests/kanjidetailsscrollareatestwindow.h .tmp/kiten+1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp kanjidetails.cpp tests/kanjidetailsscrollareatestwindow.cpp .tmp/kiten+1.0.0/ && $(COPY_FILE) --parents kanjidetails.ui .tmp/kiten+1.0.0/ && (cd `dirname .tmp/kiten+1.0.0` && $(TAR) kiten+1.0.0.tar kiten+1.0.0 && $(COMPRESS) kiten+1.0.0.tar) && $(MOVE) `dirname .tmp/kiten+1.0.0`/kiten+1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/kiten+1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_kanjidetails.cpp moc_kanjidetailsscrollareatestwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_kanjidetails.cpp moc_kanjidetailsscrollareatestwindow.cpp
...
compiler_uic_make_all: ui_kanjidetails.h
compiler_uic_clean:
	-$(DEL_FILE) ui_kanjidetails.h
...
main.o: main.cpp tests/kanjidetailsscrollareatestwindow.h
